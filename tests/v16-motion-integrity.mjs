...
expect(css.includes('.build-card:nth-child(odd)'),'Plans staggered motion compatibility CSS missing');
expect(css.includes('.method__image img'),'Founder method parallax compatibility CSS missing');
...
expect(pkg.includes('"version": "17.0.0"'),'V16 compatibility contract is not running beneath the V17 release');
...
console.log('V16 motion compatibility OK beneath V17: choreography, pointer feedback, transitions and reduced-motion protections verified.');

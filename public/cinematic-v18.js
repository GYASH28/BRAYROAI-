(() => {
  ...
  class CinematicScrollDirector{
    ...
    paintFilm(scene,phase,focus){const amp=compact?.6:1,progress=clamp01((phase+1)/2);this.set(scene,'--v19-film-frame-y',px(phase*-14*amp));this.set(scene,'--v19-film-frame-scale',(1.003+(1-focus)*.01).toFixed(5));this.set(scene,'--v19-film-ghost-x',px(phase*-36*amp));this.set(scene,'--v19-film-ghost-y',px(phase*12*amp));this.set(scene,'--v19-film-word-y',px(phase*-10*amp));this.set(scene,'--v19-film-rule-x',px(phase*24*amp));this.set(scene,'--v19-film-accent-y',px(phase*17*amp));this.set(scene,'--v20-film-scan',`${(10+progress*80).toFixed(2)}%`)}
    ...
    paintFounder(scene,phase,focus){const amp=compact?.55:1,progress=clamp01((phase+1)/2);this.set(scene,'--v19-founder-image-y',px(phase*-22*amp));this.set(scene,'--v19-founder-image-x',px(phase*-7*amp));this.set(scene,'--v19-founder-image-scale',(1.02+(1-focus)*.015).toFixed(5));this.set(scene,'--v19-founder-copy-y',px(phase*12*amp));this.set(scene,'--v19-founder-rot',deg(phase*-.35*amp));this.set(scene,'--v20-founder-scan',`${(14+progress*72).toFixed(2)}%`)}

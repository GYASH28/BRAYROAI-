...
for(const text of ['dataset.perfActive','IntersectionObserver','image.loading=\'lazy\'','link.rel=\'prefetch\'','saveData','PerformanceObserver','type:\'longtask\''])requireText(perf,text,'V22 scheduler');
forbid(perf,'requestAnimationFrame','V22 scheduler should not add its own continuous frame loop');

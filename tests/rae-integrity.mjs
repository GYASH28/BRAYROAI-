...
expect(!/canvas|webgl|three\.js|requestAnimationFrame\([^)]*render/i.test(files.character+files.characterCss+files.emotionCss),'Detailed Rae must remain lightweight SVG/CSS, not a permanent render loop');

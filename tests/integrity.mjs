...
expect(Buffer.byteLength(files.v7js)<13000,'Art Direction V7 JS exceeds 13KB guardrail');
...
console.log('Integrity OK: dual pricing + Terms + HyperFrames + V7 + Work Showcase V8 checked');

...
expect(files.bootstrap.includes('shellCharacter')&&files.bootstrap.includes('/rae/rae-illustration-thumb.webp')&&files.bootstrap.includes('stroke="#ff8a1c"'),'Rae bootstrap launcher must use the illustrated character and amber expression');
...
for(const token of ['data-rae-rig="v3"','rae-character__art','/rae/rae-illustration.webp','rae-character__eyes','rae-character__pupil','rae-character__brows','rae-character__mouth','rae-character__smile-eyes','rae-character__speaking-mouth','rae-character__listening-ring','rae-character__thought'])expect(files.character.includes(token),`Illustrated Rae rig missing ${token}`);
for(const token of ['ensureRaeCharacterSkin','/rae/rae-character-v2.css','linearGradient','radialGradient','PortraitFade'])expect(files.character.includes(token),`Rae illustrated character construction missing ${token}`);

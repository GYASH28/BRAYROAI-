...
expect(fs.statSync('public/rae/rae-illustration.webp').size<100_000&&fs.statSync('public/rae/rae-illustration-thumb.webp').size<20_000,'Rae art must stay compact for low-end devices');
...
console.log(`Rae integrity OK: ${clientBytes}B modular client, compact illustrated Rae with vector expressions, V4+V5 presentation polish, 21 emotional states, resilient streaming AI, safe actions, collision clearance and verified knowledge.`);
